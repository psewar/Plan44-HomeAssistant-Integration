...
class Plan44Store:
    ...
    def get_export(self, entity_id: str) -> dict[str, Any] | None:
        return self.data[STORE_KEY_EXPORTS].get(entity_id)

    def get_export_by_uid(self, uid: str) -> tuple[str | None, dict[str, Any] | None]:
    ...
    def iter_exports(self):
        return self.data[STORE_KEY_EXPORTS].items()
